...
public class NPCDB extends Data implements java.io.Serializable {
	...
	@org.kie.api.definition.type.Label(value = "npCreateConfirm")
	private java.lang.String npCreateConfirm;
	...
	public java.lang.String toString() {
		return "NPCDB [messageCode=" + this.messageCode + ", nPRequestId=" + this.nPRequestId + ", recipientId="
				+ this.recipientId + ", newRoute=" + this.newRoute + ", npId=" + this.npId + ", npCreateConfirm=" + this.npCreateConfirm + ", nPDueDate="
				+ this.nPDueDate + ", nrList=" + this.nrList + ", npList=" + this.npList + ", processType="
				+ this.processType + "]";
	}
	...
	public java.lang.String getNpCreateConfirm() {
		return this.npCreateConfirm;
	}

	public void setNpCreateConfirm(java.lang.String npCreateConfirm) {
		this.npCreateConfirm = npCreateConfirm;
	}

	public NPCDB(java.lang.String messageCode, java.lang.String nPRequestId,
			...
			java.lang.String npCreateConfirm) {
		this.messageCode = messageCode;
		this.nPRequestId = nPRequestId;
		this.recipientId = recipientId;
		this.newRoute = newRoute;
